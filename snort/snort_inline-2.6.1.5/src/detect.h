...
int RejectBothAction(Packet *, OptTreeNode *, Event *);
int RejectSrcAction(Packet *, OptTreeNode *, Event *);
int RejectDstAction(Packet *, OptTreeNode *, Event *);
#ifdef IPFW
int ReinjectAction(Packet *, OptTreeNode *, Event *);
#endif /* IPFW */
#endif /* GIDS */
