...
#define     STREAM4_TCP_OOO_PKTS_LIMIT          26
#define     STREAM4_TCP_OOO_BYTES_LIMIT         27
#define     STREAM4_TCP_SEQ_HOLES_LIMIT         28
#define     STREAM4_TCP_NORM_WSCALE             29
...
#define STREAM4_TCP_OOO_PKTS_LIMIT_STR "(spp_stream4) TCP out-of-order packets limit reached for stream"
#define STREAM4_TCP_OOO_BYTES_LIMIT_STR "(spp_stream4) TCP out-of-order bytes limit reached for stream"
#define STREAM4_TCP_SEQ_HOLES_LIMIT_STR "(spp_stream4) TCP sequence number holes limit reached for stream"
#define STREAM4_TCP_NORM_WSCALE_STR "(spp_stream4) TCP wscale option normalized"
